...
| [Feishu 实现独立审计](iterations/feishu-event-name-isolation-review.md) | R1～R5 已确认解决；代码与手册审计通过，待用户 push 和部署 |
...
| [Feishu EVENT_NAME 隔离方案](iterations/feishu-event-name-isolation.md) | 隔离实现与手册已放行，尚未发布部署，业务批次未收口 |
