...
def test_bigscreen_config_editor_is_loaded_before_app_and_owns_editor_state_and_dom():
    ...
    assert index.index("config/config-model.js?v=20260827a") < index.index("config/config-editor.js?v=20260827a")
    assert index.index("config/config-editor.js?v=20260827a") < index.index("app.js?v=20260828d")
...
def test_bigscreen_dhcp_panel_owns_page_state_dom_api_and_refresh_lifecycle():
    ...
    assert index.index("dhcp/dhcp-model.js?v=20260827a") < index.index("dhcp/dhcp-panel.js?v=20260827a")
    assert index.index("dhcp/dhcp-panel.js?v=20260827a") < index.index("app.js?v=20260828d")
...
def test_all_bigscreen_pages_have_mobile_layout_contracts():
    ...
    assert "app.js?v=20260828d" in html
...
def test_loss_heatmap_splits_large_device_lists_into_two_columns():
    ...
    assert index.index("charts/loss-heatmap.js?v=20260826a") < index.index("app.js?v=20260828d")
...
def test_isp_and_evidence_use_business_specific_line_chart_facades():
    ...
    assert index.index("charts/isp-chart.js?v=20260826a") < index.index("app.js?v=20260828d")
    assert index.index("charts/evidence-chart.js?v=20260826a") < index.index("evidence/evidence-panel.js?v=20260827a")
    assert index.index("evidence/evidence-panel.js?v=20260827a") < index.index("app.js?v=20260828d")
...
def test_incident_panel_owns_form_queries_rendering_and_request_lifecycle():
    ...
    assert index.index("incident/incident-panel.js?v=20260827a") < index.index("app.js?v=20260828d")
...
def test_wireless_panel_is_loaded_after_players_and_owns_page_controller():
    ...
    assert index.index("wireless/wireless-panel.js?v=20260827a") < index.index("app.js?v=20260828d")
...
def test_tournament_panel_is_loaded_after_players_and_owns_page_controller():
    ...
    assert index.index("tournament/tournament-panel.js?v=20260828a") < index.index("app.js?v=20260828d")
...
def test_iperf_controller_is_loaded_after_pure_helpers_and_owns_browser_state_machine():
    ...
    assert index.index("control/delivery-panel.js?v=20260828a") < index.index("app.js?v=20260828d")
...
def test_delivery_panel_owns_operator_actions_and_mounts_existing_iperf_controller_once():
    ...
    assert index.index("control/auth-controller.js?v=20260828a") < index.index("app.js?v=20260828d")
...
def test_topology_browser_controller_is_extracted_without_owning_refresh_or_data_fetch():
    ...
    assert index.index("charts/topology-panel.js?v=20260826a") < index.index("app.js?v=20260828d")
...
def test_bigscreen_ping_trend_uses_job_aware_rtt_presentation():
    ...
    assert "app.js?v=20260828d" in index
    ...
    assert index.index("charts/ping-chart.js?v=20260826a") < index.index("app.js?v=20260828d")
    assert index.index("metrics/ping-transform.js?v=20260826b") < index.index("app.js?v=20260828d")
