(function () {
  window.BIGSCREEN_QUERIES = {
    ...
    pingGauge: 'avg by (instance) (quantile_over_time(0.5, probe_icmp_duration_seconds{job=~"infra-isp-ping|infra-core-ping|infra-dist-ping|infra-fw-ping",phase="rtt"}[1m]))',
